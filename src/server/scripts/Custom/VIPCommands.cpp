...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        static std::vector<ChatCommand> vipCommandTable =
        {
			...
			{ "Appear",         SEC_PLAYER,    false, &HandleAppear,         "" },
			{ "Respawn",        SEC_PLAYER,   false, &HandleRespawn,         "" },
            { "mall",           SEC_PLAYER,     true,  &HandleVipMallCommand,         ""},
            ...
            { "tele",           SEC_PLAYER,     false, &HandleTeleCommand,            ""},
        };
	...
	static bool HandleRespawn(ChatHandler * handler, const char* args)
	{
